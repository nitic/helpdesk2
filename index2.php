...
<br><br>
  <body> <img src="bn.jpg" style="width: 100vw; height: 170px; ">
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <?php   include_once('apps/login.php'); ?>
          </div>
...
<br>
      ...
      <div class="container-fluid">
        ...
        <footer><center>
          ...
          โทร.2716 ติดต่อ <a href="index2.php" style="color:#000;text-decoration:none">ผู้ดูแลระบบ</a>: niti.c@psu.ac.th</center>
<br>
      </div> <!-- /container -->
